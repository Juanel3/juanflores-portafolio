  ...
  return (
    <div className="flex justify-center mb-3 md:mb-0">
      <button
        ...
        className="type-body-sm font-medium rounded-full border-2 border-[#1A7AB5] bg-black px-5 py-2.5 text-white transition-all duration-300 hover:scale-105 hover:bg-[#1A7AB5]/10 hover:shadow-lg"
      >
